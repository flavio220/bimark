...
export default function BusinessDetailsForm({ formData = {}, onFormChange, errors = {}, language = 'fr' }) {
...
BusinessDetailsForm.propTypes = { formData: PropTypes.object, onFormChange: PropTypes.func, errors: PropTypes.object, language: PropTypes.string };
