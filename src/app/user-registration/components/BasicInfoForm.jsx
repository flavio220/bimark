...
export default function BasicInfoForm({ formData = {}, onFormChange, errors = {}, language = 'fr' }) {
...
BasicInfoForm.propTypes = { formData: PropTypes.object, onFormChange: PropTypes.func, errors: PropTypes.object, language: PropTypes.string };
