...
const SUGGESTIONS = {
  fr: ['Chaises de bureau','Éclairage LED','Câbles USB','Gilets de sécurité','Lampes bureau','Armoires','Casques audio','Cartons emballage'],
  en: ['Office chairs','LED lighting','USB cables','Safety vests','Desk lamps','Storage cabinets','Headphones','Cardboard boxes'],
  es: ['Sillas de oficina','Iluminación LED','Cables USB','Chalecos de seguridad','Lámparas','Armarios','Auriculares','Cajas de cartón'],
  pt: ['Cadeiras de escritório','Iluminação LED','Cabos USB','Coletes de segurança','Luminárias','Armários','Fones de ouvido','Caixas de papelão'],
  ar: ['كراسي مكتب','إضاءة LED','كابلات USB','سترات السلامة','مصابيح','خزائن','سماعات','صناديق كرتون'],
  zh: ['办公椅','LED照明','USB线','安全背心','台灯','储物柜','耳机','纸板箱'],
};
...
export default function SearchIntegration() {
  ...
  useEffect(() => {
    ...
    const pool = SUGGESTIONS[lang] || SUGGESTIONS.fr;
